...
export default function MangaInsertarCrud() {
  const {
    params, errors,
    ...
    formato: '',
    tamaño: ''
  }, '/api/mangas/insertar', '/crud/manga', 'mangas')
      ...
      <form onSubmit={handleSubmit}
        ...
        <div className='formulario__grid contenedor'>
          <FieldsetInput
            ...
            className={`formulario__fieldset ${errors && errors.nombre ? style.error : ''}`}
            value={params.nombre}
            onChange={readParam}
          ...
          <FieldsetSelectArray
            ...
            className={`formulario__fieldset ${errors && errors.editorial ? style.error : ''}`}
          ...
          <FieldsetInput
            ...
            className={`formulario__fieldset ${errors && errors.autor ? style.error : ''}`}
            value={params.autor}
            onChange={readParam}
          ...
          <FieldsetInput
            ...
            className={`formulario__fieldset ${errors && errors.fecha_publicacion ? style.error : ''}`}
            value={params.fecha_publicacion}
            onChange={readParam}
            error={errors && errors.fecha_publicacion} />

          <FieldsetInput tipo='number' name='tomo' text='Tomo *'
            className={`formulario__fieldset ${errors && errors.tomo ? style.error : ''}`}
            value={params.tomo}
            onChange={readParam}
          ...
          <FieldsetInput
            ...
            className={`formulario__fieldset ${errors && errors.precio ? style.error : ''}`}
            value={params.precio}
            onChange={readParam}
        ...
        <div className="contenedor formulario__grid columna">
          <FieldsetTextarea name='descripcion' text='Descripcion *'
            className={`formulario__fieldset ${errors && errors.descripcion ? style.error : ''}`}
        ...
        <div className='contenedor formulario__grid'>
          <FieldsetInput
            ...
            className={`formulario__fieldset ${errors && errors.stock ? style.error : ''}`}
            value={params.stock}
            onChange={readParam}
            error={errors && errors.stock} />

          <FieldsetInput tipo='text' name='isbn' text='ISBN *'
            className={`formulario__fieldset ${errors && errors.isbn ? style.error : ''}`}
            value={params.isbn}
            onChange={readParam}
          ...
          <FieldsetInput
            ...
            className={`formulario__fieldset ${errors && errors.num_paginas ? style.error : ''}`}
          ...
          <FieldsetInput
            ...
            className={`formulario__fieldset ${errors && errors.formato ? style.error : ''}`}
            value={params.formato}
            onChange={readParam}
            error={errors && errors.formato} />

          <FieldsetInput tipo='text' name='tamaño' text='Tamaño *'
            className={`formulario__fieldset ${errors && errors.tamaño ? style.error : ''}`}
            value={params.tamaño}
            onChange={readParam}
